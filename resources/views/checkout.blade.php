            ...
            <div class="row g-5">
                ...
                <div class="col-md-12 col-lg-6 col-xl-5">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center mt-2">
                                            <img src="{{ asset($cart->product->image) }}" class="img-fluid rounded-circle"
                                    ...
                                    <td class="py-5">$ {{ $cart->product->discount_price * $cart->quantity}}</td>
                                </tr>
                                @endforeach
                                <tr>
                                    <th scope="row">
                    ...
                    <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                        <a href="{{ route('stripe') }}" id="pay-btn" class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary">
                            Place Order
                        </a>
                    </div>
                </div>
